  ...
  return (
    <>
      ...
      <p className="mt-4 mb-12 text-base font-normal text-gray-500 dark:text-gray-400 sm:text-xl">
        I am constantly updating my skill set to stay current with industry
        trends. Here are the tools I use in my work.
      </p>
          ...
          <Card key={index}>
            <div className="flex flex-col items-center">
              ...
              <div className="mt-5">
                <Button
                  color="gray"
                  className="font-bold leading-tight text-gray-700 dark:text-gray-400"
                  outline
                >
                  {skill.name}
                </Button>

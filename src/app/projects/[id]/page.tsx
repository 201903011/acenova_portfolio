...
export const metadata = {
  ...
  description:
    "Explore detailed information about my projects, showcasing my skills in web development, DevOps, and more.",
  keywords: ["project details", "portfolio", "web development", "DevOps"],
  ...
  return (
    <section className="bg-white dark:bg-gray-900 antialiased">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-12 lg:py-12">
        ...
        <div className="mt-12">
          <h3 className="text-2xl font-bold leading-tight tracking-tight text-gray-900 sm:text-2xl dark:text-white">

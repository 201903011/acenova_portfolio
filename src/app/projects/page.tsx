...
export const metadata = {
  ...
  description:
    "Explore my projects, showcasing my skills in web development, DevOps, and more.",
  keywords: ["projects", "portfolio", "web development", "DevOps"],
  ...
  openGraph: {
    ...
    description:
      "Explore my projects, showcasing my skills in web development, DevOps, and more.",
    url: "https://portfolio.acenova.dev/projects",
      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-12 lg:py-12">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mt-4 text-base font-normal text-gray-500 sm:text-xl dark:text-gray-400">
            I have worked on a variety of projects, each with its own unique
            challenges and solutions. Here are some of my most notable works.
          </p>
        </div>
        <div className="mt-12 space-y-16 sm:mt-16">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div
                className={`w-full space-y-6 lg:max-w-lg shrink-0 xl:max-w-2xl ${
